...
#define d4_printf(fmt, args...) do { fprintf(stderr, fmt, ##args); } while (0)
#define err_printf(fmt, args...) do { fprintf(stderr, fmt, ##args); } while (0)
...
extern char *indi_hostname;
extern int   indi_port;

extern char *indi_scopetemp_device;
